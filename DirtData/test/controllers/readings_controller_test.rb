...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { light: @reading.light, moisture: @reading.moisture, time: @reading.time } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { light: @reading.light, moisture: @reading.moisture, time: @reading.time } }
